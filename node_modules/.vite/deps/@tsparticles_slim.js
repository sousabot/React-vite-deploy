...
var RotateDirection;
(function(RotateDirection$1) {
	RotateDirection$1["clockwise"] = "clockwise";
	RotateDirection$1["counterClockwise"] = "counter-clockwise";
	RotateDirection$1["random"] = "random";
})(RotateDirection || (RotateDirection = {}));

//#endregion
//#region node_modules/@tsparticles/engine/browser/Enums/Types/EasingType.js
var EasingType;
(function(EasingType$1) {
	EasingType$1["easeInBack"] = "ease-in-back";
	EasingType$1["easeInCirc"] = "ease-in-circ";
	EasingType$1["easeInCubic"] = "ease-in-cubic";
	EasingType$1["easeInLinear"] = "ease-in-linear";
	EasingType$1["easeInQuad"] = "ease-in-quad";
	EasingType$1["easeInQuart"] = "ease-in-quart";
	EasingType$1["easeInQuint"] = "ease-in-quint";
	EasingType$1["easeInExpo"] = "ease-in-expo";
	EasingType$1["easeInSine"] = "ease-in-sine";
	EasingType$1["easeOutBack"] = "ease-out-back";
	EasingType$1["easeOutCirc"] = "ease-out-circ";
	EasingType$1["easeOutCubic"] = "ease-out-cubic";
	EasingType$1["easeOutLinear"] = "ease-out-linear";
	EasingType$1["easeOutQuad"] = "ease-out-quad";
	EasingType$1["easeOutQuart"] = "ease-out-quart";
	EasingType$1["easeOutQuint"] = "ease-out-quint";
	EasingType$1["easeOutExpo"] = "ease-out-expo";
	EasingType$1["easeOutSine"] = "ease-out-sine";
	EasingType$1["easeInOutBack"] = "ease-in-out-back";
	EasingType$1["easeInOutCirc"] = "ease-in-out-circ";
	EasingType$1["easeInOutCubic"] = "ease-in-out-cubic";
	EasingType$1["easeInOutLinear"] = "ease-in-out-linear";
	EasingType$1["easeInOutQuad"] = "ease-in-out-quad";
	EasingType$1["easeInOutQuart"] = "ease-in-out-quart";
	EasingType$1["easeInOutQuint"] = "ease-in-out-quint";
	EasingType$1["easeInOutExpo"] = "ease-in-out-expo";
	EasingType$1["easeInOutSine"] = "ease-in-out-sine";
...
function initSpin(particle) {
	...
	const spinPos = spinOptions.position ?? {
		x: 50,
		y: 50
	}, spinFactor$1 = .01, spinCenter = {
		x: spinPos.x * spinFactor$1 * container.canvas.size.width,
		y: spinPos.y * spinFactor$1 * container.canvas.size.height
...
var RgbIndexes$1;
(function(RgbIndexes$2) {
	RgbIndexes$2[RgbIndexes$2["r"] = 1] = "r";
	RgbIndexes$2[RgbIndexes$2["g"] = 2] = "g";
	RgbIndexes$2[RgbIndexes$2["b"] = 3] = "b";
	RgbIndexes$2[RgbIndexes$2["a"] = 4] = "a";
...
var HslIndexes;
(function(HslIndexes$1) {
	HslIndexes$1[HslIndexes$1["h"] = 1] = "h";
	HslIndexes$1[HslIndexes$1["s"] = 2] = "s";
	HslIndexes$1[HslIndexes$1["l"] = 3] = "l";
	HslIndexes$1[HslIndexes$1["a"] = 5] = "a";
...
var HslColorManager = class {
	...
	parseString(input) {
		...
		const result = /hsla?\(\s*(\d+)\s*[\s,]\s*(\d+)%\s*[\s,]\s*(\d+)%\s*([\s,]\s*(0|1|0?\.\d+|(\d{1,3})%)\s*)?\)/i.exec(input), minLength = 4, defaultAlpha$2 = 1, radix = 10;
		return result ? hslaToRgba({
			a: result.length > minLength ? parseAlpha(result[HslIndexes.a]) : defaultAlpha$2,
...
(function(RgbIndexes$2) {
	...
	RgbIndexes$2[RgbIndexes$2["g"] = 2] = "g";
	RgbIndexes$2[RgbIndexes$2["b"] = 3] = "b";
	RgbIndexes$2[RgbIndexes$2["a"] = 5] = "a";
...
function drawEmoji(data, image) {
	const { context, opacity } = data, half$8 = .5, previousAlpha = context.globalAlpha;
	if (!image) return;
	const diameter = image.width, radius = diameter * half$8;
...
var EmojiDrawer = class {
	...
	particleInit(_container, particle) {
		const double$9 = 2, shapeData = particle.shapeData;
		...
		const padding = emojiOptions.padding * double$9, maxSize = getRangeMax(particle.size.value), fullSize = maxSize + padding, canvasSize = fullSize * double$9;
		let image;
		if (typeof OffscreenCanvas !== "undefined") {
			const canvas = new OffscreenCanvas(canvasSize, canvasSize), context = canvas.getContext("2d");
			if (!context) return;
			context.font = `400 ${maxSize * double$9}px ${font}`;
...
function processAttract(engine, container, position, attractRadius, area, queryCb) {
	...
	for (const particle of query) {
		const { dx, dy, distance } = getDistances(particle.position, position), velocity = attractOptions.speed * attractOptions.factor, attractFactor$1 = clamp(engine.getEasing(attractOptions.easing)(identity$3 - distance / attractRadius) * velocity, minFactor, attractOptions.maxSpeed), normVec = Vector.create(!distance ? velocity : dx / distance * attractFactor$1, !distance ? velocity : dy / distance * attractFactor$1);
...
function divBounce(container, divs, bounceMode$1, enabledCb) {
	divModeExecute(bounceMode$1, divs, (selector, div) => singleSelectorBounce(container, selector, div, (pos, radius, area) => processBounce(container, pos, radius, area, enabledCb)));
}
...
var Bouncer = class extends ExternalInteractorBase {
	...
	clear() {}
	init() {
		const container = this.container, bounce$1 = container.actualOptions.interactivity.modes.bounce;
		if (!bounce$1) return;
		container.retina.bounceModeDistance = bounce$1.distance * container.retina.pixelRatio;
	}
	interact() {
...
(function(ProcessBubbleType$1) {
	ProcessBubbleType$1["color"] = "color";
	ProcessBubbleType$1["opacity"] = "opacity";
	ProcessBubbleType$1["size"] = "size";
...
var Bubbler = class extends ExternalInteractorBase {
	constructor(container, engine) {
		super(container);
		this._clickBubble = () => {
			const container$1 = this.container, options = container$1.actualOptions, mouseClickPos = container$1.interactivity.mouse.clickPosition, bubbleOptions = options.interactivity.modes.bubble;
			if (!bubbleOptions || !mouseClickPos) return;
			if (!container$1.bubble) container$1.bubble = {};
			const distance = container$1.retina.bubbleModeDistance;
			if (!distance || distance < minDistance$5) return;
			const query = container$1.particles.quadTree.queryCircle(mouseClickPos, distance, (p) => this.isEnabled(p)), { bubble } = container$1;
			for (const particle of query) {
				if (!bubble.clicking) continue;
				particle.bubble.inRange = !bubble.durationEnd;
				const distMouse = getDistance(particle.getPosition(), mouseClickPos), timeSpent = ((/* @__PURE__ */ new Date()).getTime() - (container$1.interactivity.mouse.clickTime ?? defaultClickTime)) / millisecondsToSeconds;
				...
				const sizeData = {
					bubbleObj: {
						optValue: container$1.retina.bubbleModeSize,
						value: particle.bubble.radius
					},
					particlesObj: {
						optValue: getRangeMax(particle.options.size.value) * container$1.retina.pixelRatio,
		...
		this._hoverBubble = () => {
			const container$1 = this.container, mousePos = container$1.interactivity.mouse.position, distance = container$1.retina.bubbleModeDistance;
			if (!distance || distance < minDistance$5 || !mousePos) return;
			const query = container$1.particles.quadTree.queryCircle(mousePos, distance, (p) => this.isEnabled(p));
			for (const particle of query) {
				particle.bubble.inRange = true;
				const pointDistance = getDistance(particle.getPosition(), mousePos), ratio = ratioOffset - pointDistance / distance;
				if (pointDistance <= distance) {
					if (ratio >= minRatio && container$1.interactivity.status === mouseMoveEvent) {
						this._hoverBubbleSize(particle, ratio);
						this._hoverBubbleOpacity(particle, ratio);
						this._hoverBubbleColor(particle, ratio);
					}
				} else this.reset(particle);
				if (container$1.interactivity.status === mouseLeaveEvent) this.reset(particle);
			}
		};
		...
		this._hoverBubbleSize = (particle, ratio, divBubble) => {
			const container$1 = this.container, modeSize = divBubble?.size ? divBubble.size * container$1.retina.pixelRatio : container$1.retina.bubbleModeSize;
			if (modeSize === void 0) return;
			const optSize = getRangeMax(particle.options.size.value) * container$1.retina.pixelRatio, pSize = particle.size.value, size = calculateBubbleValue(pSize, modeSize, optSize, ratio);
			if (size !== void 0) particle.bubble.radius = size;
		};
		this._process = (particle, distMouse, timeSpent, data) => {
			const container$1 = this.container, bubbleParam = data.bubbleObj.optValue, bubbleOptions = container$1.actualOptions.interactivity.modes.bubble;
			if (!bubbleOptions || bubbleParam === void 0) return;
			const bubbleDuration = bubbleOptions.duration, bubbleDistance = container$1.retina.bubbleModeDistance, particlesParam = data.particlesObj.optValue, pObjBubble = data.bubbleObj.value, pObj = data.particlesObj.value ?? defaultBubbleValue, type = data.type;
			if (!bubbleDistance || bubbleDistance < minDistance$5 || bubbleParam === particlesParam) return;
			if (!container$1.bubble) container$1.bubble = {};
			if (container$1.bubble.durationEnd) {
				if (pObjBubble) {
		...
		this._singleSelectorHover = (delta, selector, div) => {
			const container$1 = this.container, selectors = document.querySelectorAll(selector), bubble = container$1.actualOptions.interactivity.modes.bubble;
			if (!bubble || !selectors.length) return;
			selectors.forEach((item) => {
				const elem = item, pxRatio = container$1.retina.pixelRatio, pos = {
					x: (elem.offsetLeft + elem.offsetWidth * half$5) * pxRatio,
					y: (elem.offsetTop + elem.offsetHeight * half$5) * pxRatio
				}, repulseRadius = elem.offsetWidth * half$5 * pxRatio, area = div.type === DivType.circle ? new Circle(pos.x, pos.y, repulseRadius) : new Rectangle(elem.offsetLeft * pxRatio, elem.offsetTop * pxRatio, elem.offsetWidth * pxRatio, elem.offsetHeight * pxRatio), query = container$1.particles.quadTree.query(area, (p) => this.isEnabled(p));
				for (const particle of query) {
...
function drawConnectLine(context, width, lineStyle$1, begin, end) {
	drawLine(context, begin, end);
	context.lineWidth = width;
	context.strokeStyle = lineStyle$1;
	context.stroke();
}
...
var Grabber = class extends ExternalInteractorBase {
	...
	interact() {
		...
		if (!interactivity.modes.grab || !interactivity.events.onHover.enable || container.interactivity.status !== mouseMoveEvent) return;
...
var Pauser = class extends ExternalInteractorBase {
	constructor(container) {
		...
		this.handleClickMode = (mode) => {
			...
			const container$1 = this.container;
			if (container$1.animationStatus) container$1.pause();
			else container$1.play();
		};
	}
	clear() {}
	init() {}
...
var Pusher = class extends ExternalInteractorBase {
	constructor(container) {
		...
		this.handleClickMode = (mode) => {
			...
			const container$1 = this.container, pushOptions = container$1.actualOptions.interactivity.modes.push;
			if (!pushOptions) return;
			const quantity = getRangeValue(pushOptions.quantity);
			if (quantity <= minQuantity) return;
			const group = itemFromArray([void 0, ...pushOptions.groups]), overrideOptions = deepExtend(group !== void 0 ? container$1.actualOptions.particles.groups[group] : void 0, itemFromSingleOrMultiple(pushOptions.particles));
			container$1.particles.push(quantity, container$1.interactivity.mouse, overrideOptions, group);
		};
	}
	clear() {}
	init() {}
...
var Remover = class extends ExternalInteractorBase {
	constructor(container) {
		super(container);
		this.handleClickMode = (mode) => {
			const container$1 = this.container, options = container$1.actualOptions;
			if (!options.interactivity.modes.remove || mode !== removeMode) return;
			const removeNb = getRangeValue(options.interactivity.modes.remove.quantity);
			container$1.particles.removeQuantity(removeNb);
		};
	}
	clear() {}
	init() {}
...
var Repulser = class extends ExternalInteractorBase {
	constructor(engine, container) {
		super(container);
		this._clickRepulse = () => {
			const container$1 = this.container, repulseOptions = container$1.actualOptions.interactivity.modes.repulse;
			if (!repulseOptions) return;
			const repulse = container$1.repulse ?? { particles: [] };
			if (!repulse.finish) {
				if (!repulse.count) repulse.count = 0;
				repulse.count++;
				if (repulse.count === container$1.particles.count) repulse.finish = true;
			}
			if (repulse.clicking) {
				const repulseDistance = container$1.retina.repulseModeDistance;
				if (!repulseDistance || repulseDistance < minDistance$2) return;
				const repulseRadius = Math.pow(repulseDistance / repulseRadiusFactor, repulseRadiusPower), mouseClickPos = container$1.interactivity.mouse.clickPosition;
				if (mouseClickPos === void 0) return;
				const range = new Circle(mouseClickPos.x, mouseClickPos.y, repulseRadius), query = container$1.particles.quadTree.query(range, (p) => this.isEnabled(p));
				for (const particle of query) {
		...
		this._hoverRepulse = () => {
			const container$1 = this.container, mousePos = container$1.interactivity.mouse.position, repulseRadius = container$1.retina.repulseModeDistance;
			if (!repulseRadius || repulseRadius < minRadius$1 || !mousePos) return;
			this._processRepulse(mousePos, repulseRadius, new Circle(mousePos.x, mousePos.y, repulseRadius));
		};
		this._processRepulse = (position, repulseRadius, area, divRepulse) => {
			const container$1 = this.container, query = container$1.particles.quadTree.query(area, (p) => this.isEnabled(p)), repulseOptions = container$1.actualOptions.interactivity.modes.repulse;
			if (!repulseOptions) return;
		...
		this._singleSelectorRepulse = (selector, div) => {
			const container$1 = this.container, repulse = container$1.actualOptions.interactivity.modes.repulse;
			if (!repulse) return;
			const query = document.querySelectorAll(selector);
			if (!query.length) return;
			query.forEach((item) => {
...
var DisposalMethod;
(function(DisposalMethod$1) {
	DisposalMethod$1[DisposalMethod$1["Replace"] = 0] = "Replace";
	DisposalMethod$1[DisposalMethod$1["Combine"] = 1] = "Combine";
	DisposalMethod$1[DisposalMethod$1["RestoreBackground"] = 2] = "RestoreBackground";
	DisposalMethod$1[DisposalMethod$1["RestorePrevious"] = 3] = "RestorePrevious";
	DisposalMethod$1[DisposalMethod$1["UndefinedA"] = 4] = "UndefinedA";
	DisposalMethod$1[DisposalMethod$1["UndefinedB"] = 5] = "UndefinedB";
	DisposalMethod$1[DisposalMethod$1["UndefinedC"] = 6] = "UndefinedC";
	DisposalMethod$1[DisposalMethod$1["UndefinedD"] = 7] = "UndefinedD";
})(DisposalMethod || (DisposalMethod = {}));

//#endregion
//#region node_modules/@tsparticles/shape-image/browser/GifUtils/Types/GIFDataHeaders.js
var GIFDataHeaders;
(function(GIFDataHeaders$1) {
	GIFDataHeaders$1[GIFDataHeaders$1["Extension"] = 33] = "Extension";
	GIFDataHeaders$1[GIFDataHeaders$1["ApplicationExtension"] = 255] = "ApplicationExtension";
	GIFDataHeaders$1[GIFDataHeaders$1["GraphicsControlExtension"] = 249] = "GraphicsControlExtension";
	GIFDataHeaders$1[GIFDataHeaders$1["PlainTextExtension"] = 1] = "PlainTextExtension";
	GIFDataHeaders$1[GIFDataHeaders$1["CommentExtension"] = 254] = "CommentExtension";
	GIFDataHeaders$1[GIFDataHeaders$1["Image"] = 44] = "Image";
	GIFDataHeaders$1[GIFDataHeaders$1["EndOfFile"] = 59] = "EndOfFile";
...
var Linker = class extends ParticlesInteractorBase {
	constructor(container, engine) {
		...
		this._setColor = (p1) => {
			...
			const container$1 = this._linkContainer, linksOptions = p1.options.links;
			let linkColor = linksOptions.id === void 0 ? container$1.particles.linksColor : container$1.particles.linksColors.get(linksOptions.id);
			if (linkColor) return;
			const optColor = linksOptions.color;
			linkColor = getLinkRandomColor(this._engine, optColor, linksOptions.blink, linksOptions.consent);
			if (linksOptions.id === void 0) container$1.particles.linksColor = linkColor;
			else container$1.particles.linksColors.set(linksOptions.id, linkColor);
		};
...
var LinkInstance = class {
	constructor(container, engine) {
		this._drawLinkLine = (p1, link) => {
			...
			const container$1 = this._container, options = container$1.actualOptions, p2 = link.destination, pos1 = p1.getPosition(), pos2 = p2.getPosition();
			let opacity = link.opacity;
			container$1.canvas.draw((ctx) => {
				let colorLine;
				...
				if (!colorLine) colorLine = getLinkColor(p1, p2, p1LinksOptions.id !== void 0 ? container$1.particles.linksColors.get(p1LinksOptions.id) : container$1.particles.linksColor);
				if (!colorLine) return;
				...
				drawLinkLine({
					...
					engine: this._engine,
					maxDistance,
					canvasSize: container$1.canvas.size,
		...
		this._drawLinkTriangle = (p1, link1, link2) => {
			...
			const container$1 = this._container, options = container$1.actualOptions, p2 = link1.destination, p3 = link2.destination, opacityTriangle = triangleOptions.opacity ?? (link1.opacity + link2.opacity) * half;
			...
			container$1.canvas.draw((ctx) => {
				...
				if (!colorTriangle) colorTriangle = getLinkColor(p1, p2, linksOptions.id !== void 0 ? container$1.particles.linksColors.get(linksOptions.id) : container$1.particles.linksColor);
...
var PolygonDrawer = class extends PolygonDrawerBase {
	...
	getSidesData(particle, radius) {
		const sides$5 = particle.sides;
		return {
			count: {
				denominator: 1,
				numerator: sides$5
			},
			length: radius * yFactor$1 / (sides$5 / sidesFactor)
		};
	}
};
...
function drawStar(data) {
	const { context, particle, radius } = data, sides$5 = particle.sides, inset = particle.starInset ?? defaultInset$1;
	context.moveTo(origin.x, origin.y - radius);
	for (let i = 0; i < sides$5; i++) {
		context.rotate(Math.PI / sides$5);
